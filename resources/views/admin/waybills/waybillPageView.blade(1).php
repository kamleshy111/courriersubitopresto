...
<div class="container">
                ...
                <td style="border: 1mm solid black; padding: 10px; ">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td colspan="2"><p>{{ $shipper->address ?? 'N/A' }}</p></td>
                ...
                <td style="border: 1mm solid black; padding: 10px">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td colspan="2"><p>{{$recipient->address?? 'address'}}</p></td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <p><b>Note destinataire</b></p>
            
                                <p style="font-size:6mm;">{{$waybill->receiver_note??'N/D'}} </p>
 ...
 @if($waybill->drop_image)
                            ...
                            <td style="padding-top: 30px">
                                ...
                                <table width="100%" cellpadding="5" cellspacing="5" style="border: 1mm solid black; padding: 10px;">
                                    ...
                                    <tr>
                                            ...
                                            <td style="border: 0.5mm solid black;" width="50%">Tarif</td>
                                              ...
                                              @php
                                                ...
                                                $cleanedPrice = preg_replace('/[^0-9\.\-]/', '', $raw);
                                                $formattedPrice = number_format((float)$cleanedPrice, 2);
                                            ...
                                            @role('admin'||'Driver')
                                                ...
                                                <td style="border: 0.5mm solid black;" width="25%">{{$waybill->cost_2}}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 0.5mm solid black;">{{$waybill->total}}</td>
    ...
    <p style="margin: 0;">Date: {{ $waybill->drop_time ? date('m-d-Y', strtotime($waybill->drop_time)) : '__________' }}</p>
