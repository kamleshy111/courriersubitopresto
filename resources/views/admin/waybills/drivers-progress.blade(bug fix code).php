...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log(`note ID: ${note.id}, shortDescription: ${sortDescription} `);
            ...
            var dispacherIndexNumber = additionalData.findIndex(data => Number(data.id) === Number(dispacherId));

            console.log("dispacher number: ");
            console.log(dispacherIndexNumber);
            if (dispacherIndexNumber !== -1) {
    var prefix = additionalData[dispacherIndexNumber].prefix;
    // Continue with your logic using 'prefix'
} else {
    console.error("No matching data found for dispacherId:", dispacherId);
