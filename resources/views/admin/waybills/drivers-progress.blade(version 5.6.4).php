            ...
            <tbody id="table-body">
                <tr>
                    ...
                    <td id="cell60">
                        ...
                        <div class="note-editable" data-table="dashboard" data-column="notes" data-id="60"> {{$cell60_note}}</div>
                    </td>
                    <td  id="cell61">
                        {{-- <div class="cheque" id="cheque">Cheque</div> --}}
                        <div class="note-editable" data-table="dashboard" data-column="notes" data-id="60"> {{$cell61_note}}</div>
                    </td>
                </tr>
                <tr>
                    <td>
...
function translateStatus(status) {
    ...
    function fetchAndGenerateNotes(refresh=false) {
        Promise.all([fetchNotes(), fetchDriverData(), fetchAdditionalData()])
            .then(([notes, drivers, additionalData]) => {
                if (notes || drivers || additionalData) {
                    ...
                    generateTopStickyNotes(notes, additionalData,drivers,refresh);
...
function saveEditedData(selectedNoteId, columnName , tableName, newValue,dashboardCellId=false,selectedClientId=false,dashboardNotes = false) {
