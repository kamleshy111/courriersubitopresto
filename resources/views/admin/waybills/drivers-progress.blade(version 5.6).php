...
$eric_cheque = $drivers->where('id', "10")->first()->cheque_note  ?? "driver not found";
$jorge_cheque = $drivers->where('id', "27")->first()->cheque_note ?? "driver not found";
$andre_cheque = $drivers->where('id', "43")->first()->cheque_note ?? "driver not found";
$raymond_cheque = $drivers->where('id', "49")->first()->cheque_note ?? "driver not found";
$arnaud_cheque = $drivers->where('id', "51")->first()->cheque_note ?? "driver not found";
$achraf_cheque = $drivers->where('id', "55")->first()->cheque_note ?? "driver not found";
$sylvain_cheque = $drivers->where('id', "64")->first()->cheque_note ?? "driver not found";
