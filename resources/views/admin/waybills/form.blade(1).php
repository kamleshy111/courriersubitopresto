            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm">
                        ...
                        {!! Form::textarea($i.'.note_permanent', 'Notes facultatives (Non permanentes)')->placeholder("Cubages supplémentaires pour marchandises multiples, #P.O, #Commande, #Référence, etc") !!}
