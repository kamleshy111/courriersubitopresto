{{-- version 5.6.9 bug fixed version  --}}
{{-- 
    => same time update for automation & new waybill appear in the dashboard fixed!
--}}
{{--
...
<div class="container mt-4" style="margin: 0px; padding-left:0px; padding-rigth:0px; ">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <button id="btn-open-new-popup" class="btn btn-lg btn-success" >Bordereaux Rapide</button>
    </div>
</div>
        ...
        <table id="maintable" class="table table-bordered">
            ...
            <tr>
                ...
                <th rowspan="2">Eric 10 <br>(438) 221-9112 <br>20 pieds tailgate </th>
                <th rowspan="2">Jorge 27 <br>(514) 792-7169<br>26 pieds</th>
                <th rowspan="2">André 43 <br> (514) 829-1298 <br>22 pied tailgate</th>
                <th rowspan="2">Raymond 49 <br> (514) 863-8082 <br>caravane </th>
                <th rowspan="2">Arnaud 51 <br> (512) 880-9690 <br> 22pieds </th>
            ...
            <tbody id="table-body">
                <tr>
                    ...
                    <td  id="cell61">
                        ...
                        {{-- <div class="note-editable" data-table="dashboard" data-column="notes" data-id="61">
                            ...
                            <ul id="note-list-61" class="note-editable" data-table="dashboard" data-column="notes" data-id="61">
                                {!! $cell61_note !!}
                            </ul>
                ...
                <tr>
                    ...
                    <td id="cell63">
                        {{-- <div  class="note-editable" data-table="dashboard" data-column="notes" data-id="63"> {{$cell63_note}}</div> --}}
                            ...
                            <ul id="note-list-63" class="note-editable" data-table="dashboard" data-column="notes" data-id="63">
                                {!! $cell63_note !!}
                            </ul>
                    </td>
                ...
                <tr>
                    ...
                    <td id="cell65">
                        ...
                        <div>
                            <ul id="note-list-65" class="note-editable" data-table="dashboard" data-column="notes" data-id="65">
                                {!! $cell65_note !!}
                            </ul>
                            </div>
                    </td>
                ...
                <tr>
                    ...
                    <td id="cell67">
                        {{-- <div  class="note-editable" data-table="dashboard" data-column="notes" data-id="67"> {{$cell67_note}}</div> --}}
                            ...
                            <ul id="note-list-67" class="note-editable" data-table="dashboard" data-column="notes" data-id="67">
                                {!! $cell67_note !!}
                            </ul>
                ...
                <tr>
                    ...
                    <td id="cell69">
                        {{-- <div  class="note-editable" data-table="dashboard" data-column="notes" data-id="69"> {{$cell69_note}}</div> --}}
                            ...
                            <ul id="note-list-69" class="note-editable" data-table="dashboard" data-column="notes" data-id="69">
                                {!! $cell69_note !!}
                            </ul>
                ...
                <tr>
                    ...
                    <td id="cell71">
                        {{-- <div  class="note-editable" data-table="dashboard" data-column="notes" data-id="71"> {{$cell71_note}}</div> --}}
                            ...
                            <ul id="note-list-71" class="note-editable" data-table="dashboard" data-column="notes" data-id="71">
                                {!! $cell71_note !!}
                            </ul>
    ...
    <div id="contextMenu" class="custom-context-menu">
        ...
        <div id= "chaufferMenu"class="menu-item">
            ...
            <div class="sub-menu-item" id="Eric 10">Eric 10
                <div class="sub-menu1">
            ...
            <div class="sub-menu-item" id="Jorge 27">Jorge 27
                <div class="sub-menu1">
            ...
            <div class="sub-menu-item" id="Arnaud 51">Arnaud 51
            ...
            <div class="sub-menu-item" id="Sylvain 64">Sylvain 64
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    btnOpenNewPopup.addEventListener('click', function () {
        ...
        setTimeout(() => {
        iframe.src = localUrl; // Set the new URL in the iframe
    ...
    // addDragAndDropToCells();
        ...
        notes.forEach((note,index) => {
            ...
            var price = note.dashboard_price;
            // var clientID = note.
                ...
                <table class="bottom-note-table bottom-table" style="width:100%";>
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="editable" data-table="waybills" data-column="dashboard_price" data-id=${note.id}>${price? price : "0.00"}<span> $</span></td>

                                </tr>
                                <tr>
                                    <td class="editable" data-table="waybills" data-column="waiting_time_1" data-id=${note.id}>${note.waiting_time_1? `${note.waiting_time_1}` : "" }</td>
                                ...
                                <tr>
                                    ...
                                    <td class="editable" data-table="waybills" data-column="truck_1" data-id=${note.id}>${note.truck_1? `${note.truck_1}` : ""}</td>
                        ...
                        <div class="bottom-note-body" >
                            <div class="bottom-from-to-section">
                                <div class="bottom-from-section">
                                    ...
                                    <span class="contact-name client-editable" data-table="clients" data-column="contact" data-id=${dispacherId} style="margin-right: 10px;"> ${dispacherContact? dispacherContact : "Not found"}</span>
                            ...
                            <p id="bottom-special-Note" contenteditable="true">${note.note || 'NOTES'}</p>
                                ...
                                <div class="bottom-to-section">
                                    ...
                                    <div class="contact-info">
                                    <span class="contact-name client-editable" data-table="clients" data-column="contact" data-id=${receiverID} style="margin-right: 10px;"> ${receiverContact ? receiverContact : "Not found "}</span>
        ...
        // console.log(`saved position variable datatype: ${typeof(savedPosition)}`);
            ...
            if (savedPosition != null) {
                ...
                console.log("new waybill appeared & added to bottom container!");
                stickyNotesContainer.appendChild(noteDiv);
            }
    ...
    document.getElementById("Eric 10").addEventListener("click", function () {
        // alert("found!");
        console.log(selectedStickyNote);
    ...
    document.getElementById("64Donner").addEventListener("click", function () {
        ...
        driverId = "64";
        updateTableCell(waybillId,driverId);
        insertNoteInCell(selectedStickyNote,"cell17");
        driverAssignment(waybillId,driverId);
            // destinationCell.appendChild(selectedStickyNote);
            // cell0.appendChild(selectedStickyNote); // Move sticky note to cell 0
            // showAllNotes();
...
function translateStatus(status) {
    ...
    async function driverAssignment(waybillId,driverId,delivery_status=false){
...
function showAllNotes() {
    ...
    if(localData !=null){
        const chequesavedState = localData.cheque;
        const absentSavedState = localData.absent;
        ...
        if (absentSavedState =="visible"){
            cellAbsentContentDiv.classList.remove('hidden');
        }
        else if (absentSavedState =="hidden"){
    ...
    //    if (cellId == "cell0" || cellId == "cell1" || cellId == "cell" || cellId == "cell9" || cellId == "cell10" || cellId == "cell18" || cellId == "cell19" || cellId == "cell20" || cellId == "cell21" || cellId == "cell29" || cellId == "cell30" || cellId == "cell31" || cellId == "cell39" ||)
        ...
        else if (chequesavedState === 'hidden'){
...
absentButton.addEventListener('click', () => {
  ...
  if (cellAbsentContentDiv) {
    ...
    else if(!isHiddenAbsent){
        // localStorage.setItem('absent', 'hidden');
        localData.absent = "hidden";
        localData.cheque = "visible";
        // localData.cheque = ""
    //   localStorage.setItem(cellId, 'visible');
    console.log(`absent value(hidden) : ${localData.absent} `);
    console.log(`cheque value(hidden) : ${localData.cheque} `);
      localStorage.setItem(cellId, JSON.stringify(localData));
    //   localData.cheque = "";
    //   localData.absent = "";
      console.log(`Saved state for cell ${cellId}: hide`);
    }*/
    // old condition ends
    ...
    // Optionally: If you want to track the hidden state as well, you could store that as 'hidden'
    // else {
    //   localStorage.setItem(cellId, 'hidden');
    // }
...
function loadExternalCSS() {
    ...
    // Loop through the array and add each link to the <head> tag
    ...
    // Optionally, load custom styles as well (if necessary)
