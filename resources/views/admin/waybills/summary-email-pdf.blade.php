        ...
        <table width="100%">
            ...
            <tr>
                        ...
                        <td colspan="2">
                                ...
                                <p style="font-size:12px;"><b>Heures d’ouverture + Informations permanentesr</b></p>
            
                                <p style="font-size:10px;" >{{$shipper_note??$shipper_note??'N/D'}}</p>
            ...
            <tr>
                        ...
                        <td colspan="2">
                                ...
                                <p style="font-size:12px;"><b>Heures d’ouverture + Informations permanentes</b></p>
            
                                <p style="font-size:10px;">{{$recipient_note??$recipient_note??'N/D'}} </p>
