@section('col1')
    @if($type == 1)
        @php $color = '#B089F8'; @endphp
    @else
        @if($status == 'tomorrow')
            @php $color = '#8fdefb'; @endphp
        @elseif($status == 'same_day')
            @php $color = '#a6f4ee'; @endphp
        @else
            @php $color = ''; @endphp
        @endif
    @endif
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <table width="100%">
                                            <tr>
                                                <td align="left"><p>{{$shipper['city']['name']}}</p></td>
                                                <td align="center"><p>Québec</p></td>
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <table width="100%">
                                            <tr>
                                                <td align="left"><p>{{$recipient['city']['name']}}</p></td>
                                                <td align="center"><p>Québec</p></td>
