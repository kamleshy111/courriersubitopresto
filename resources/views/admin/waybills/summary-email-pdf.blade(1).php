@section('col1')
    ...
    @endphp
    <div style="opacity: 1%; background-color: {{ $color }}">
        <table width="100%">
            <tr>
                        <td align="center">
            ...
            <tr>
                        ...
                        <td colspan="2">
                                ...
                                <p style="font-size:12px;" >{{$shipper_note??$shipper_note??'N/D'}}</p>
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <p>Signature: <span style="margin-top: -50px; text-align: center; border-bottom: 1px solid black; padding-bottom: 2px; display: inline-block; width: 100px; margin-right:15px;">{{ $sender_textSignature ? $sender_textSignature : " " }}</span>Heure: <span style="margin-left: 10px;"> {{ $pickup_time ? date('H:i', strtotime($pickup_time)) : '____________' }} </span>
                            @if($pickup_image)
                                    
                                <img src="{{ asset('storage/' . $pickup_image) }}" alt="Pickup Image" class="img-thumbnail" width="80" style="display: inline; margin-left:25px;">
            ...
            <tr>
                        ...
                        <td colspan="2">
                                ...
                                <p style="font-size:14px;">{{$receiver_note??$receiver_note??'N/D'}} </p>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        ...
                                        <p>Signature: <span style="margin-top: -50px; text-align: center; border-bottom: 1px solid black; padding-bottom: 2px; display: inline-block; width: 100px; margin-right:15px;">{{ $receiver_textSignature ? $receiver_textSignature : "____________" }}</span> Heure: {{ $drop_time ? date('H:i', strtotime($drop_time)) : '____________' }} </span>
                                         @if($drop_image)
                                    
                                <img src="{{ asset('storage/' . $drop_image) }}" alt="Pickup Image" class="img-thumbnail" width="80" style="display: inline; margin-left:25px;">
            ...
            <tr>
                        <td style="padding-top:20px;">
                            ...
                            <p style="background: {{ isset($note_permanent) ? 'yellow' : 'white'}};font-size:6mm;">{{$note_permanent??'N/D'}}</p>
                        </td>
                    </tr>
        </table>
    </div>
            ...
            <td style="padding-top: 30px">
                                        <table width="100%" cellpadding="5" cellspacing="5" style="border: 1mm solid black; padding: 10px;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="border: 0.5mm solid black;" width="25%">{{$cost_1}}</td>
