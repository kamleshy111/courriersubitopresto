...
<div class="container">
    ...
    <div class="waybill-container">
        ...
        <!-- Table 1: Shipper & Recipient Info -->
                ...
                <td style="border: 1mm solid black; padding: 10px; ">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td colspan="2"><p>{{ $shipper->address ?? 'N/A' }} {{ !empty($shipper->address_ext) ? ' (' . $shipper->address_ext . ')' : '' }}</p></td>
                            ...
                            <td colspan="2">
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left"><p>{{$shipper->city_name ?? 'N/A' }}</p></td>

                                        <td align="center"><p>{{$shipper->city_state ?? 'N/A' }}</p></td>

                                        <td align="right" contenteditable="true"><p>{{$shipper->postal_code ?? 'N/A' }}</p></td>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><p>{{$shipper->contact??'Aucune information de contact supplémentaire'}}</p></td>
                        ...
                        {{--<tr>
                            ...
                            <td colspan="2"><p>Signature: ________________________ Heure: ____________</p></td>
                        ...
                        <td colspan="2">
                            ...
                            {{-- @if (!empty($waybill->signature) && !empty($waybill->pickup_image))



                                <div style="text-align: center;">

                                    <img src="{{ asset('storage/' . $waybill->signature) }}" alt="Signature" class="img-thumbnail" width="100" style="display: block;  margin-left: 75px; margin-bottom:-75px;">

                                </div>

                                @elseif (!empty($waybill->signature) && empty($waybill->pickup_image))



                                <div style="text-align: center;">

                                    <img src="{{ asset('storage/' . $waybill->signature) }}" alt="Signature" class="img-thumbnail" width="100" style="display: block;  margin-left: 75px; margin-bottom:-25px;">

                                </div>

                                 @endif --}}

                                {{-- <p>Signature: {{ $waybill->signature_note ? $waybill->signature_note : " " }} <span style="border-bottom: 1px solid black; display: inline-block; margin-top: 10px; padding-left: 0px; width: 200px;"></span>Heure: {{ $waybill->pickup_time ? date('H:i', strtotime($waybill->pickup_time)) : '____________' }} --}}
                ...
                <td style="border: 1mm solid black; padding: 10px">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td colspan="2"><p>{{$recipient->address?? 'address'}} {{ !empty($recipient->address_ext) ? ' (' . $recipient->address_ext . ')' : '' }}</p></td>
                            ...
                            <td colspan="2">
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left"><p>{{$recipient->city_name??'city_name not found'}}</p></td>

                                        <td align="center"><p>{{$recipient->city_state??'n/a'}}</p></td>

                                        <td align="right"><p>{{$recipient->postal_code??'n/a'}}</p></td>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><p>{{$recipient->contact??'Aucune information de contact supplémentaire'}}</p></td>
                        ...
                        <tr>
                            ...
                            {{--<td colspan="2">
                                ...
                                @if (!empty($waybill->signature))

                                <div style="text-align: center;">

                                    <img src="{{ asset('storage/' . $waybill->signature) }}" alt="Signature" class="img-thumbnail" width="100" style="display: block;  margin-left: 125px; margin-bottom:-15px;">

                                </div>

                                 @endif

                                <p>Signature: ________________________ Heure: ____________</p></p></td>--}}
                                ...
                                {{-- @if (!empty($waybill->signature)&& !empty($waybill->drop_image))
                                ...
                                @elseif (!empty($waybill->signature) && empty($waybill->drop_image))
                                ...
                                <div style="text-align: center;">
                                 ...
                                 @endif --}}
                                    ...
                                    {{-- <p>Signature:  ______________ Heure: {{ $waybill->drop_time ? date('H:i', strtotime($waybill->drop_time)) : '____________' }} --}}

                                        <p>Signature: <span style="margin-top: -50px; text-align: center; border-bottom: 1px solid black; padding-bottom: 2px; display: inline-block; width: 100px; margin-right:15px;">{{ $waybill->receiver_textSignature ? $waybill->receiver_textSignature : " " }}</span>Heure: <span style="margin-left: 10px;">{{ $waybill->drop_time ? date('H:i', strtotime($waybill->drop_time)) : '____________' }} </span>
 ...
 @if($waybill->drop_image)
    ...
    auth()->check() && auth()->user()->roles->contains('id', 2)
        ? 'white'
        : (isset($waybill->note_permanent) ? 'yellow' : 'white')
}}; font-size:6mm;">{{$waybill->note_permanent??'N/D'}}</p>
        ...
        <div class="waybill-table">
            ...
            <table id="right-table">
                                ...
                                <table width="100%" >
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p>{{ Carbon\Carbon::parse($waybill->date)->format('Y-m-d') }}</p>



                                            <p>No. Client: {{$waybill->user_id??""}}</p>

                                        </td>

                                        <td valign="top">

                                            <p><u>PAYÉ PAR:</u> <b>{{__('waybills.who_pay.'.$waybill->who_pay)}}</b></p>
                                    ...
                                    <tr>
                                        ...
                                        data-id="{{$waybill->id}}" data-table= "waybills" data-column="description"

                                        ondblclick="updateWaybillCell(this, 'waybills', {{$waybill->id}}, 'description')">

                                            <p>{{$waybill->description??'Aucune description'}}</p>
                            ...
                            <td style="padding-top: 30px">
                                ...
                                <table width="100%" cellpadding="5" cellspacing="5" style="border: 1mm solid black; padding: 10px;">
                                    ...
                                    <tr>
                                            ...
                                            <td style="border: 0.5mm solid black;" width="50%">Tarif</td>
                                              ...
                                              @php
                                                ...
                                                //$formattedPrice = str_replace(',', '.', $waybill->price);

                                                //$formattedPrice = str_replace(',', '.', $waybill->dashboard_price);

                                                // $formattedPrice = $waybill->dashboard_price;

                                                $raw = $waybill->dashboard_price ?? '0';
                                                $normalized_price = str_replace(',', '.', $raw);
                                                $cleanedPrice = preg_replace('/[^0-9\.\-]/', '', $normalized_price);
                                                $formattedPrice = is_numeric($cleanedPrice) ? (float) $cleanedPrice : 0;
                                            ...
                                            <td style="border: 0.5mm solid black;" width="25%">
                                                ...
                                                @else
                                                    ...
                                                    @if($waybill->submission_status == 0 && $waybill->price != null)
                                            ...
                                            {{--@else
                                                ...
                                                @if($waybill->submission_status == 0)
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 0.5mm solid black;">{{$waybill->hazardous_materials_1}}</td>

                                        <td style="border: 0.5mm solid black;">{{$waybill->hazardous_materials_2}}</td>
                                    ...
                                    <tr>
                                        ...
                                        data-id="{{$waybill->id}}" data-table= "waybills" data-column="poids"

                                        ondblclick="updateWaybillCell(this, 'waybills', {{$waybill->id}}, 'weight_1')">{{$waybill->weight_1}}</td>

                                        <td style="border: 0.5mm solid black;">{{$waybill->weight_2}}</td>
                                    ...
                                    <tr>
                                        ...
                                        data-id="{{$waybill->id}}" data-table= "waybills" data-column="cubing_1"

                                        ondblclick="updateWaybillCell(this, 'waybills', {{$waybill->id}}, 'cubing_1')">{{$waybill->cubing_1}}</td>

                                        <td style="border: 0.5mm solid black;">{{$waybill->cubing_2}}</td>
                                    ...
                                    {{-- <tr>
                                        ...
                                        ondblclick="updateWaybillCell(this, 'waybills', {{$waybill->id}}, 'round_trip_1')">{{$waybill->round_trip_1}}</td>
                                    ...
                                    <tr>
                                        ...
                                        ondblclick="updateWaybillCell(this, 'waybills', {{$waybill->id}}, 'round_trip_1')"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 0.5mm solid black;">{{$waybill->truck_1}}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 0.5mm solid black;">{{$waybill->tailgate_1}}</td>

                                                <td style="border: 0.5mm solid black;">{{$waybill->tailgate_2}}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 0.5mm solid black;">{{$waybill->user->client->prefix.str_pad($waybill->soft_id, 6, 0, STR_PAD_LEFT)}}</td>
                        ...
                        <tr>
                            ...
                            @php
                                ...
                                if ($waybill->status === 'tomorrow') {

                                    $translated_status = 'Lendemain';

                                }

                                else if ($waybill->status === 'same_day') {

                                        $translated_status = 'Même Jour';

                                }



            else if ($waybill->status === 'urgent') {

                $translated_status = 'urgent';

            }



            else if ($waybill->status === 'very_urgent') {

                $translated_status = 'TRES urgent';



            }

            else if ($waybill->status === 'code_red') {

                    $translated_status = 'Code Rouge';
            ...
            else if ($waybill->status === 'special_night') {

                $translated_status = 'SPECIAL NIGHT';
                            ...
                            <td>
                                ...
                                <p style="font-size: 9mm;">Type d’envoi : <b style="background: {{ auth()->check() && auth()->user()->roles->contains('id', 2) ? '#ffffff' : 'yellow' }}"><u>{{$translated_status}}</u></b></p>
                        ...
                        <tr>
                            ...
                            {{--<td style="padding-top: 20px">
                                ...
                                <p>Chauffeur: {{$waybill->driver_id?$waybill->driver_id :''}} </p>
                        ...
                        <tr>
                            ...
                            <td class="mt-1" style="display: flex; justify-content: space-between; align-items: center;">

    {{--<p style="margin: 0;">Chauffeur: {{$waybill->driver_id ? $waybill->driver_id : ''}}</p>--}}
    <p style="margin: 0;">
        Chauffeur:
        {{ $waybill->driver_id
    ...
    <p style="margin: 0;">Date: {{ $waybill->drop_time ? date('Y-m-d', strtotime($waybill->drop_time)) : '__________' }}</p>
...
#right-table{
    ...
    /*.waybill-table {
        ...
        background-color: {{
            ...
            $status == 'tomorrow' ? '#8fdefb' :

            ($status == 'same_day' ? '#a6f4ee' :

            ($status == 'urgent' ? '#FDFD96' :

            ($status == 'code_red' ? '#e3342f' : '#ffffff')))
    ...
    @media (max-width: 768px) {
        ...
        .waybill-container {
            ...
            transform: scale(.35); /* Scales down both tables */

            transform-origin: top left; /* Keeps position stable */
            ...
            width: 1200px; /* Ensures the full layout is maintained */
        ...
        .waybill-table {
            ...
            min-width: 50%; /* Ensures two equal columns */
...
{{-- <script> --}}
    ...
    {{-- // JavaScript to adjust scaling dynamically --}}
...
<script>
    ...
    function updateWaybillCell(cell, table, id, column) {

        var oldValue = cell.innerText.trim(); // Get the old value
        ...
        input.addEventListener('blur', function () {
            ...
            if (newValue !== oldValue) { // Update only if value is changed

                console.log(document.querySelector('td[data-column="poids"]').innerText);

                updateCellData(table, id, column, oldValue, newValue);

                console.log("New value found!", newValue);



            } else {

                // document.querySelector(`[data-id="${id}"] td[data-column="${column}"]`).innerHTML = oldValue;

                console.log(document.querySelector('td[data-column="poids"]').innerText);

                // cell.innerHTML = oldValue; // Restore old value if unchanged
    ...
    function updateCellData(table, id, column, oldValue, newValue) {

        fetch('{{ route('driver.waybill.update') }}', {
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                // Update the cell text only if successful

                // cell.innerHTML = newValue;

                // document.querySelector(`[data-id="${id}"] td[data-column="${column}"]`).innerText = newValue;

                // document.querySelectorAll('td[data-column="weight_1"]').td.innerHTML = "newValue";
                ...
                // Restore old value in case of failure

                // document.querySelector(`[data-id="${id}"] td[data-column="${column}"]`).innerText = oldValue;

                // document.querySelectorAll('td[data-column="weight_1"]').td.innerHTML = "oldValue";
        ...
        .catch(error => {
            ...
            // Restore old value in case of network error

            // document.querySelector(`[data-id="${id}"] td[data-column="${column}"]`).innerText = oldValue;

            // document.querySelectorAll('td[data-column="weight_1"]').td.innerHTML = "oldValue"; // Replace with your desired text
