                        ...
                        <td colspan="2">
                            @if (!empty($waybill->signature))
                                <div style="text-align: center;">
                                 ...
                                 @endif
                                    <p>Signature:  ______________ Heure: {{ $waybill->pickup_time ? date('H:i', strtotime($waybill->pickup_time)) : '' }}
                            ...
                            {{--<td colspan="2">
                                ...
                                <div style="text-align: center;">
                                 ...
                                 @endif
                                    ...
                                    <p>Signature:  ______________ Heure: {{ $waybill->drop_time ? date('H:i', strtotime($waybill->drop_time)) : '' }}
        ...
        <div class="waybill-table">
            <table id="right-table">
                ...
                $translated_status = 'SPECIAL NIGHT';
                        ...
                        <tr>
                            <td class="mt-1">
                                <p>Chauffeur: ________________________________  Date: {{ $waybill->drop_time ? date('m-d-Y', strtotime($waybill->drop_time)) : '' }}
</p>
                            </td>
                        </tr>
