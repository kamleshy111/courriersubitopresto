            ...
            noteDiv.innerHTML = `
                ...
                <table class="bottom-note-table bottom-table">
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td contenteditable="false">8:00</td>
                                ...
                                <tr>
                                    ...
                                    <td class="editable" data-table="waybills" data-column="weight_1" data-id=${note.id}>${note.weight_1? `${note.weight_1} lbs`: ""}</td>
