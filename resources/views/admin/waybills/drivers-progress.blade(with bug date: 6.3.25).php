...
{{--
        problem: <span class="left-text client-editable" data-table="clients" data-column="city_name" data-id=${receiverID}>${receiverCityName.toUpperCase()}</span>
        solution: <span class="left-text client-editable" data-table="clients" data-column="city_name" data-id=${receiverID}">${receiverCityName ? receiverCityName.toUpperCase() : 'City Not Found'}</span>
        in generateTopStickyNotes() function
--}}
