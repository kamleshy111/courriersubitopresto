                        ...
                        <td colspan="2">
                            {{-- @if (!empty($waybill->signature) && !empty($waybill->pickup_image))
                                ...
                                {{-- <p>Signature: {{ $waybill->signature_note ? $waybill->signature_note : " " }} <span style="border-bottom: 1px solid black; display: inline-block; margin-top: 10px; padding-left: 0px; width: 200px;"></span>Heure: {{ $waybill->pickup_time ? date('H:i', strtotime($waybill->pickup_time)) : '____________' }} --}}
                                    <p>Signature: <span style="margin-top: -50px; text-align: center; border-bottom: 1px solid black; padding-bottom: 2px; display: inline-block; width: 100px; margin-right:15px;">{{ $waybill->signature_note ? $waybill->signature_note : " " }}</span>Heure: <span style="margin-left: 10px;"> {{ $waybill->pickup_time ? date('H:i', strtotime($waybill->pickup_time)) : '____________' }} </span>
                                ...
                                <div style="text-align: center;">
                                 ...
                                 @endif --}}
                                    ...
                                    {{-- <p>Signature:  ______________ Heure: {{ $waybill->drop_time ? date('H:i', strtotime($waybill->drop_time)) : '____________' }} --}}
                                        <p>Signature: <span style="margin-top: -50px; text-align: center; border-bottom: 1px solid black; padding-bottom: 2px; display: inline-block; width: 100px; margin-right:15px;">{{ $waybill->signature_note ? $waybill->signature_note : " " }}</span>Heure: <span style="margin-left: 10px;">{{ $waybill->drop_time ? date('H:i', strtotime($waybill->drop_time)) : '____________' }} </span>
