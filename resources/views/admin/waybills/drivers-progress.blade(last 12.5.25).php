                        ...
                        <div class="bottom-note-body" >
                            <div class="bottom-from-to-section">
                                <div class="bottom-from-section">
                                    ...
                                    <span class="contact-name editable" data-table="waybills" data-column="shipper_contact" data-id=${note.id} style="margin-right: 10px;"> ${dispacherContact? dispacherContact : "Not found"}</span>
                            ...
                            <p class="bottom-special-Note" data-table="waybills" data-column="shipper_note" data-id=${note.id}>${dispacherNote || 'NOTES'}</p>
                                ...
                                <div class="bottom-to-section">
                                    ...
                                    <div class="contact-info">
                                    <span class="contact-name editable" data-table="waybills" data-column="recipient_contact" data-id=${note.id} style="margin-right: 10px;"> ${receiverContact ? receiverContact : "Not found "}</span>
