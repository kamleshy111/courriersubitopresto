            ...
            <tr>
                <td style="border: 1mm solid black; padding: 10px; ">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td colspan="2"><p>{{$shipper['address']}} {{ !empty($shipper['address_ext']) ? ' (' . $shipper['address_ext'] . ')' : '' }}</p></td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <table width="100%">
            ...
            <tr>
                <td style="border: 1mm solid black; padding: 10px">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td colspan="2"><p>{{$recipient['address']}} {{ !empty($recipient['address_ext']) ? ' (' . $recipient['address_ext'] . ')' : '' }}</p></td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <table width="100%">
...
{{--                                                @endphp--}}
                                                <td style="border: 0.5mm solid black;" width="25%">
                                                    @if($price != null && ((auth()->check() && auth()->user()->hasRole('admin')) || $submission_status != '1'))
                                                        {{ $price }}
                                                    @endif
                                                </td>
...
{{--                                                @endif--}}
                                            ...
                                            <tr>
                                                ...
                                                <td style="border: 0.5mm solid black;"></td>
