            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm">
                        ...
                        <fieldset id="{{ $i }}_shipper" @if($errors->has('shipper_id')) style="border-color:red; color:red;" @endif>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    ...
                                    {!! Form::text($i.'.shipper.city_state')->placeholder('state')->readonly($readonly_shipper) !!}
                            ...
                            <div class="row">
                                    ...
                                    {!! Form::text($i.'.shipper_note','EXPÉDITEUR Note:')->placeholder('shipper note') !!}
                        ...
                        <fieldset id="{{$i}}_recipient" class="my-3" {!! $errors->has('recipient_id') ? 'style="border-color:red;color:red"' : '' !!}>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    ...
                                    {!! Form::text($i.'.recipient.city_state')->placeholder('state')->readonly($readonly_recipient) !!}
                            ...
                            <div class="row">
                                    ...
                                    {!! Form::text($i.'.receiver_note', 'Recipient Note:')->placeholder('recipient note') !!}
                        ...
                        {!! Form::textarea($i.'.note_permanent', 'Note permanente:')->placeholder("Merci de fournir vos heures d'ouverture et les détails sur l'accès des camions ; ces informations seront enregistrées pour chaque client dans notre logiciel.") !!}
                    ...
                    <div class="col-sm">
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        {!! Form::textarea($i.'.description')->placeholder('Description / Colis / Po, No de référence client') !!}
                        ...
                        <fieldset class="fullinput" style="border:0">
                            ...
                            <div class="row bordered">
                                ...
                                <div class="col-sm-4">Matière dangeureuse (Kg)</div>
