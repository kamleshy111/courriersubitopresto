...
function translateStatus(status) {
    ...
    async function driverAssignment(waybillId,driverId){
...
function deleteWaybill(waybillId, status=0,selectedWaybill=false) {
