...
<div class="container mt-4" style="margin: 0px; padding-left:0px; padding-rigth:0px; ">
            ...
            <tbody id="table-body">
                <tr>
                    ...
                    <td class="note-container" id="cell3">
                        <div class="cheque hidden" >
                            <span>Cheque</span>
                            <div class="cheque-editable" data-table="users" data-column="cheque_note" data-id="27">Custom Text</div>
                         </div>
                    </td>
                    <td class="note-container" id="cell4">
                        <div class="cheque hidden" >
                            <span>Cheque</span>
                            <div class="cheque-editable" data-table="users" data-column="cheque_note" data-id="43">Custom Text</div>
                         </div>
                    </td>
                    <td class="note-container" id="cell5">
                        <div class="cheque hidden" >
                            <span>Cheque</span>
                            <div class="cheque-editable" data-table="users" data-column="cheque_note" data-id="49">Custom Text</div>
                         </div>
                    </td>
                    <td class="note-container" id="cell6">
                        <div class="cheque hidden" >
                            <span>Cheque</span>
                            <div class="cheque-editable" data-table="users" data-column="cheque_note" data-id="52">Custom Text</div>
                         </div>
                    </td>
                    <td class="note-container" id="cell7">
                        <div class="cheque hidden" >
                            <span>Cheque</span>
                            <div class="cheque-editable" data-table="users" data-column="cheque_note" data-id="55">Custom Text</div>
                         </div>
                    ...
                    <td class="note-container"> --}}
                        <div class="cheque hidden" >
                            <span>Cheque</span>
                            <div class="cheque-editable" data-table="users" data-column="cheque_note" data-id="64">Custom Text</div>
                         </div>
                ...
                <tr>
                    ...
                    <td class="note-container" id="cell15">
                        <div class="cheque hidden" >
                            <span>Cheque</span>
                            <div class="cheque-editable" data-table="users" data-column="cheque_note" data-id="51">Custom Text</div>
                         </div>
                    </td>
                    ...
                    {{-- </td> --}}
                    <td class="note-container side-note" id="cell18"></td>
                ...
                <tr>
                    ...
                    <!-- <td></td> -->
                    <td>Bureau</td>
                    <td class="note-container side-note" id="cell52"></td>
                </tr>
            </tbody>
        </table>
    ...
    <div id="contextMenu" class="custom-context-menu">
        ...
        <div id= "chaufferMenu"class="menu-item">
            ...
            <div class="sub-menu-item" id="Jolio 27">Jorge 27
                <div class="sub-menu1">
            ...
            <div class="sub-menu-item" id="Arnaud 52">Arnaud 51
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateTopStickyNotes(notes, additionalData,drivers) {
        flag = 0;
                ...
                <table class="bottom-note-table bottom-table" style="width:100%";>
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td contenteditable="false">${price? price: ""}</td>
                                </tr>
                                <tr>
                        ...
                        <div class="bottom-note-body" >
                            <div class="bottom-from-to-section">
                                <div class="bottom-from-section">
                                    ...
                                    <span class="contact-name client-editable" data-table="clients" data-column="contact" data-id=${dispacherId}> ${dispacherContact? dispacherContact : "Not found"}</span>
                                    </div>
                                    <div class="two-line">
                            ...
                            <p id="bottom-special-Note" contenteditable="true">${note.note || 'NOTES'}</p>
                                ...
                                <div class="bottom-to-section">
                                    ...
                                    <span class="contact-name client-editable" data-table="clients" data-column="contact" data-id=${receiverID}> ${receiverContact? receiverContact : "Not found"}</span>
                                    </div>
                                    {{---<div class="two-line">
        ...
        Promise.all([fetchNotes(), fetchDriverData(), fetchAdditionalData()])
            .then(([notes, drivers, additionalData]) => {
                if (notes || drivers || additionalData) {
                    ...
                    console.dir(notes);
                    console.log(drivers);
                    generateTopStickyNotes(notes, additionalData,drivers);
...
function showAllNotes() {
    ...
    const savedState = localStorage.getItem(cellId);
