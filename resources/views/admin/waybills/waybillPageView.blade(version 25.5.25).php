 ...
 @if($waybill->drop_image)
            ...
            <tr>
                ...
                <td style="padding-top:20px;">
                    ...
                    <p style="background: {{ isset($waybill->note_permanent) ? 'yellow' : 'white'}};font-size:6mm;">{{$waybill->note_permanent??'N/D'}}</p>
            ...
            <table id="right-table">
                ...
                $translated_status = 'SPECIAL NIGHT';
                            ...
                            <td>
                                ...
                                <p style="font-size: 9mm;">Type d’envoi : <b style="background:yellow"><u>{{$translated_status}}</u></b></p>
