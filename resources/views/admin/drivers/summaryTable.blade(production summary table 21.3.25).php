            ...
            <tbody id="waybillTableBody">
                @foreach($waybills as $waybill)
                    <tr>
                        ...
                        <td contenteditable="true" class="editable-cell price-cell" data-field="price">{{ number_format($waybill->price, 2) }} $</td>
                    </tr>
                @endforeach
            </tbody>
            <tfoot>
...
<table class="table table-bordered table-striped">
    <thead>
        <tr>
            ...
            @else
            <th colspan="2">Nom: Unknown Driver</th>
            @endif
            @if($waybills->isNotEmpty())
    ...
    <tbody>
        ...
        @foreach($waybills as $waybill)
            <tr>
                ...
                <td >{{ $waybill->status ?? 'N/A' }}</td>
                <td >{{ $waybill->description ?? 'N/A' }}</td>
                <td >{{ number_format($waybill->price, 2) }} $</td>
            </tr>
