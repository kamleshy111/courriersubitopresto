            ...
            <tbody id="waybillTableBody">
                @foreach($waybills as $waybill)
                    {{-- @php
                        ...
                        $status = statusUpdate ($status_raw);
                        // echo $status;
                        function statusUpdate(value){
                            // var $temp;

                            if(strtolower($value) == "tomorrow")
                            {

                                $temp = "Lendemain";
                            }
                            // else if(strtolower($value) == "même jour" || strtolower($value) == "meme jour")
                            else if(strtolower($value) == "same_day")
                            {
                            ...
                            else if(strtolower($value) == "urgent")
                            {

                                $temp = "urgent";
                            }

                            else if(strtolower($value) == "very_urgent")
                            {

                                $temp = "TRES urgent";
                            }

                            else if(strtolower($value) == "code_red")
                            {
                            ...
                            else if(strtolower($value) == "night")
                            {
                    ...
                    <tr>
                        ...
                        {{-- <td contenteditable="true" class="editable-cell" data-field="status">{{ $status ?? 'N/A' }}</td> --}}
                        <td contenteditable="true" class="editable-cell" data-field="description">{{ $waybill->description ?? 'N/A' }}</td>
                        <td contenteditable="true" class="editable-cell price-cell" data-field="price">{{ number_format($waybill->comission_price, 2) }} $</td>
                        <td >
...
function saveFrontendWaybillField(cell) {
    ...
    show$TemporaryMessage(cell, '✔️ updated');
}

// Optional: Show a small saved message
function show$TemporaryMessage(cell, message) {
