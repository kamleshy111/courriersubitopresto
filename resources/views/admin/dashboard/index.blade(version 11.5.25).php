    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                    ...
                    <div class="card" style="border-radius: 14px; background-color: #800020; width: 100%; height: 134px;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex">
                                ...
                                <p class="d-flex flex-column">
                                    ...
                                    <span class="text-bold text-lg value" style="color: #ffffff;">Livraison en cours (à venir)</span>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex">
                            ...
                            <p class="d-flex flex-column">
                                ...
                                <span class="text-bold text-lg value" style="color: #ffffff;">Preuves de livraison (à venir)<br> 
                                Livraison terminé (à venir)</span>
        ...
        <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex">
                                ...
                                <p class="d-flex flex-column">
                                    ...
                                    <span class="text-bold text-lg value" style="color: #ffffff;">Livraison ramassé (à venir)</span>
            ...
            <div class="col-md-4">
                ...
                <a href="{{ url('admin/clients') }}">
                    ...
                    <div class="card" style="border-radius: 14px; background-color: #808080; width: 100%; height: 134px;">
            ...
            <div class="col-md-4">
                ...
                <div class="card" style="border-radius: 14px; background-color: #8fdefb; width: 100%; height: 134px;">
                        ...
                        <div class="card" style="height: auto;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="limited-text">
                                    ...
                                    <div id="client_news_full" style="display: block;">
