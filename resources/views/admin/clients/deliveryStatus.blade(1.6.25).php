...
@section('content')
    ...
    <div class="container">
        ...
        <table class="table table-bordered table-striped">
            {{--<thead>
                <tr>
                    ...
                    <th class="col-2">Adresse du client de l'expediteur</th>
                    <th class="col-2">Nom du client destinataire</th>
                    <th class="col-2">Adresse du client destinataire</th>
      ...
      <tr>
          <th class="col-2">Nom du client de l'expediteur</th>
                    <th class="col-12 col-sm-1">Adresse du client de l'expediteur</th>
...
@endforeach --}}
        ...
        @empty
            <tr>
                <td colspan="5" class="text-center">Aucune lettre de voiture trouvée</td>
            </tr>
        @endforelse
    </tbody>
        </table>
