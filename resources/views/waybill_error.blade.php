...
<head>
    ...
    <style>
        ...
        .my-custom-col {
            flex: 1 1 45%; /* Default: Each column takes up 45% width for 2 columns */
            margin: 2px 0;
            padding: 8px;
        ...
        /* For mobile devices: Ensure two columns remain in one row */
        @media (max-width: 768px) {
            .my-custom-col {
                flex: 1 1 45%; /* Ensure 2 columns on mobile */
        ...
        @media (max-width: 480px) {
            .my-custom-col {
                flex: 1 1 45%; /* Keep 2 columns in 1 row */
                            ...
                            <td style="border: 1mm solid black; padding-right: 10px;">
                                <table width="100%" >
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <p><u>PAYÉ PAR:</u> <b>waybills.who_pay.'.$who_pay</b></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">
                        ...
                        <tr>
                            <td style="padding-top: 30px">
                                <table width="100%" cellpadding="5" cellspacing="5" style="border: 1mm solid black; padding: 10px;">
                                    ...
                                    <tr>
                                        <td style="border: 0.5mm solid black;">Temps d