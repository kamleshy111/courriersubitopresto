...
if($body.hasClass('admin-waybills-create') || $body.hasClass('admin-waybills-edit')) {
    ...
    function init_form(counter, who) {
        ...
        $("#btn-" + counter + "-change-" + who + "").on('click', function() {
            ...
            $("#inp-" + counter + "-" + who + "_id,#inp-" + counter + "-" + who + "-name,#inp-" + counter + "-" + who + "-phone,#inp-" + counter + "-" + who + "-extension,#inp-" + counter + "-" + who + "-address,#inp-" + counter + "-" + who + "-city_name,#inp-" + counter + "-" + who +"-city_state,#inp-" + counter + "-" + who +"-postal_code,#inp-" + counter + "-" + who + "-contact,#inp-" + counter + "-" + who + "_note" ).val('').removeAttr('readonly');
