...
if($body.hasClass('admin-waybills-create') || $body.hasClass('admin-waybills-edit')) {
    ...
    function fillClient(counter, who, item) {
        ...
        $("#inp-" + counter + "-" + who + "-address_ext").val(item.address_ext);
        ...
        $("#inp-" + counter + "-" + who + "_note").val(item.note_permanent);

        $("#btn-" + counter + "-change-" + who + "").removeClass('d-none');

      if(who === 'recipient'){
        // $("#inp-" + counter + "-" + who + "receiver_note").val(item.note_permanent);
    ...
    function init_form(counter, who) {
        ...
        $("#btn-" + counter + "-change-" + who + "").on('click', function() {
            ...
            $("#inp-" + counter + "-" + who + "_id,#inp-" + counter + "-" + who + "-name,#inp-" + counter + "-" + who + "-phone,#inp-" + counter + "-" + who + "-extension,#inp-" + counter + "-" + who + "-address,#inp-" + counter + "-" + who + "-city_name,#inp-" + counter + "-" + who +"-city_state,#inp-" + counter + "-" + who +"-postal_code,#inp-" + counter + "-" + who + "-contact,#inp-" + counter + "-" + who + "_note,#inp-"+ counter + "-" + who +"-address_ext" ).val('').removeAttr('readonly');
