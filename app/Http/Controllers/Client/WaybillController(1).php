        ...
        ->editColumn('delivery_status', function ($row) {
            ...
            switch ($row->delivery_status) {
                ...
                case 1:
                    ...
                    return '<span class="badge badge-pill" style="' . $style . '">ramassée</span>';

                case 2:

                    return '<span class="badge badge-pill" style="' . $style . '">en cours</span>';

                case 3:

                    return '<span class="badge badge-pill" style="' . $style . '">livraison</span>';
