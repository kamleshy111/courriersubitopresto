...

{
    ...
    $validated = $request->validate([
        ...
        $allowedColumns = ['user_id', 'status', 'phone', 'contact', 'address', 'city_name', 'postal_code', 'stickyNote_day', 'description' , 'weight_1', 'truck_1', 'waiting_time_1','note_permanent','dashboard_position','cheque_note','notes','dashboard_price','comission_price', 'shipper_note','recipient_note','shipper_contact', 'recipient_contact']; // Replace with your columns
