...
public function emailReport(Request $request){
    ...
    if(!empty($waybillsToSend)) {
                    ...
                    try {Mail::html('<p>Bonjour Courrier Subito presto,</p>
    <p>Le chauffeur a terminé sa journée et a transmis son bordereau de livraison.</p>
    <p>Vous trouverez en pièce jointe l