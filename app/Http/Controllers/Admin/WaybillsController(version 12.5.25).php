...
class WaybillsController extends CRUDController {
    ...
    Log::info('Validation checker:', ['value' => $validator_checker]);
        ...
        if ($validator_checker) {
            ...
            for($i = 0; $i <= $request->get('counter', 0); $i++) {
                ...
                if ($request->has('receiver_note')) {
                    $model->receiver_note = $request->input('receiver_note');
                }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->has('.recipient.contact'))
            ...
            if ($request->has('receiver_note')) {
                $waybill->receiver_note = $request->input('receiver_note');
            }
...
public function updateApprovalStatus(Request $request)
{
    ...
    $tableName = "waybills";
    $columnName = "approval_status,driver_id,delivery_status";
