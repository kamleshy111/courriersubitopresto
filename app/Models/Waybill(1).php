...
class Waybill extends BaseModel {
    ...
    public $rules_update = [
        ...
        '*.shipper_note'          => 'nullable|max:100',
        '*.recipient_note'      =>   'nullable|max:100',
        '*.tailgate_1'      =>   'nullable|max:100',
        '*.tailgate_2'      =>   'nullable|max:100',
    ];
    ...
    protected static function boot() {
        ...
        self::creating(function($model) {
            ...
            // new version test
            /*if (empty($model->user_id) && ( request()->query('waybill') == 'true' &&  request()->query('mode') != 'rapid') ) {
                $model->user_id = \Auth::id();
                \Log::info('Auto-set user_id from Auth in normal mode.');
            } else {
                \Log::info('Using manually entered user_id: ' . $model->user_id);
            }*/
        });
    }
