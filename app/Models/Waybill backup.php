...
class Waybill extends BaseModel {
    ...
    public $rules = [
        ...
        '*.shipper_id'            => 'required_without_all:*.shipper.name,*.shipper.phone,*.shipper.address,*.shipper.city_id,*.shipper.postal_code|nullable|exists:clients,id',
        '*.recipient_id'          => 'required_without_all:*.recipient.name,*.recipient.phone,*.recipient.address,*.recipient.city_id,*.recipient.postal_code|nullable|exists:clients,id',
        ...
        '*.shipper.city_id'       => 'required_without:*.shipper_id',
        ...
        '*.recipient.city_id'     => 'required_without:*.recipient_id',
